...
//-(void) getTOTP:(NSString*) semilla tiempo:(NSString*)tiempo fecha:(NSString*) fecha
//{
//    NSString *msg=@"\(semilla) \(tiempo) \(fecha)";
//    
//    double duration=DEFAULT_TOAST_DURATION;
//    
